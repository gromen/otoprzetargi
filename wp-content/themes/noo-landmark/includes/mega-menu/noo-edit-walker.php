				...
				<dt class="menu-item-handle">
					...
					<span class="item-controls">
	                    ...
	                    <span class="item-order hide-if-js">
	                        <a href="<?php
	                        echo wp_nonce_url( esc_url( add_query_arg( array(
			...
			<div class="noo-icon">
				...
				<div class="menu-item-actions submitbox">
					...
					echo wp_nonce_url( esc_url( add_query_arg( array(
						...
						'menu-item' => $item_id,
					), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) ), 'delete-menu_item_' . $item_id ); ?>"><?php esc_html_e( 'Remove', 'noo-landmark' ); ?></a>
