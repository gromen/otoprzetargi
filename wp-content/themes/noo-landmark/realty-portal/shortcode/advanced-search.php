...
<div class="noo-advanced-search-property">
     ...
     */
    if ( 'property' == $source ) : ?>
        <form class="rp-validate-form noo-advanced-search-property-form <?php echo esc_attr( $class_form ) ?>" action="<?php echo RP_Member::get_url_search(); ?>" method="get" accept-charset="utf-8">
            <?php
                /**
                 * Show google map
                 */
