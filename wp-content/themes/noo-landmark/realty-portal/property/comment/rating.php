 ...
 */
$label_box_rating         = apply_filters( 'rp_label_box_rating', esc_html__( 'Your Rating', 'noo-landmark' ) );


$label_rating_5_stars     = apply_filters( 'rp_label_rating_5_stars', esc_html__( 'Awesome - 5 stars', 'noo-landmark' ) );
$label_rating_4half_stars = apply_filters( 'rp_label_rating_4half_stars', esc_html__( 'Pretty good - 4.5 stars', 'noo-landmark' ) );
$label_rating_4_stars     = apply_filters( 'rp_label_rating_4_stars', esc_html__( 'Pretty good - 4 stars', 'noo-landmark' ) );
$label_rating_3half_stars = apply_filters( 'rp_label_rating_3half_stars', esc_html__( 'Meh - 3.5 stars', 'noo-landmark' ) );
$label_rating_3_stars     = apply_filters( 'rp_label_rating_3_stars', esc_html__( 'Meh - 3 stars', 'noo-landmark' ) );
$label_rating_2half_stars = apply_filters( 'rp_label_rating_2half_stars', esc_html__( 'Kinda bad - 2.5 stars', 'noo-landmark' ) );
$label_rating_2_stars     = apply_filters( 'rp_label_rating_2_stars', esc_html__( 'Kinda bad - 2 stars', 'noo-landmark' ) );
$label_rating_1half_stars = apply_filters( 'rp_label_rating_1half_stars', esc_html__( 'Meh - 1.5 stars', 'noo-landmark' ) );
$label_rating_1_stars     = apply_filters( 'rp_label_rating_1_stars', esc_html__( 'Sucks big time - 1 star', 'noo-landmark' ) );
$label_rating_0half_stars = apply_filters( 'rp_label_rating_0half_stars', esc_html__( 'Sucks big time - 0.5 stars', 'noo-landmark' ) );
?>
