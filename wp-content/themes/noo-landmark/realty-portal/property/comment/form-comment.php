...
$title_box_comment       = apply_filters( 'noo_property_label_form_comment', esc_html__( 'Your Review', 'realty-portal' ) );
$button_text_box_comment = apply_filters( 'noo_property_txt_button_comment', esc_html__( 'Submit', 'realty-portal' ) );
...
$enable_allows_guests_review = get_theme_mod( 'noo_property_enable_allows_guests_review', true );
?>
