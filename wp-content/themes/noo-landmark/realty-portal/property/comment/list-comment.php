 ...
 */
global $property;
$title_user_comment         = apply_filters( 'noo_property_label_list_comment', esc_html__( 'Reviews', 'realty-portal' ) );
$text_loadmore_user_comment = apply_filters( 'noo_property_txt_loadmore_comment', esc_html__( 'Load more', 'realty-portal' ) );

$comment_per_page = get_theme_mod( 'noo_property_number_comment', 3 );
...
<?php if ( $total_comment > $comment_per_page ) : ?>
    <div class="noo-loadmore-comment rp-loadmore-comment">
