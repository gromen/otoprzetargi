...
if ( ! function_exists( 'ns_ui_slider_param' ) ) :

	function ns_ui_slider_param( $settings, $value ) {
	...
	ns_add_shortcode_param( 'ui_slider', 'ns_ui_slider_param' );
