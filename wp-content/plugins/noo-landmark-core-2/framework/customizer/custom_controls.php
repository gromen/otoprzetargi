...
function noo_customizer_add_custom_controls($wp_customize)
{
    ...
    class NOO_Customizer_Control_Checkbox extends WP_Customize_Control
    {
        ...
        public function __construct($manager, $id, $args = array(), $options = array())
        {
            ...
            if (isset($args['data_on']) && !empty($args['data_on'])) {
                ...
                $this->data_on = esc_html__('ON', 'noo-landmark-core');
            }

            if (isset($args['data_off']) && !empty($args['data_off'])) {
                $this->data_off = $args['data_off'];
            } else {
                $this->data_off = esc_html__('OFF', 'noo-landmark-core');
            }
        }
        ...
        public function render_content()
        {
            ?>
            <label>
                <input id="noo-checkbox-<?php echo esc_attr($this->id); ?>" type="checkbox"
    ...
    class NOO_Customizer_Control_Switch extends NOO_Customizer_Control_Checkbox
    {
        ...
        public function render_content()
        {
            ...
            <div class="noo-switch">
                <input id="noo-switch-<?php echo esc_attr($this->id); ?>" type="checkbox"
                       value="<?php echo esc_attr($this->value()); ?>" <?php $this->link();
                checked($this->value()); ?> />
                <label for="noo-switch-<?php echo esc_attr($this->id); ?>"
                       data-on="<?php echo esc_attr($this->data_on); ?>"
                       data-off="<?php echo esc_attr($this->data_off); ?>"></label>
            </div>
            <?php // Add script if there's child-options setting.
            $this->_get_inline_script();
        }
    ...
    class NOO_Customizer_Control_UI_Slider extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            $html = array();
            $max_txt = (!empty($this->json['data_max'])) ?  $this->json['data_max'] : '100';
            ?>
            <label class="noo-control">
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <input id="noo-ui-slider-<?php echo esc_attr($this->id); ?>" type="text" <?php $this->link(); ?>
                       class="noo-slider"
                       value="<?php echo esc_textarea($this->value()); ?>" <?php echo($data_min . ' ' . $data_max . ' ' . $data_step); ?>/>
    ...
    class NOO_Customizer_Control_Radio_IMG extends WP_Customize_Control
    {
        public $type = 'radio';
        ...
        public function render_content()
        {
            ...
            foreach ($this->choices as $value => $label) :
                ?>
                <label
                    class="customize-radio-image <?php if ($value == $this->value()) echo 'customize-radio-image-selected'; ?>">
                    <input class="customize-radio-image-input" type="radio" value="<?php echo esc_attr($value); ?>"
                           name="<?php echo esc_attr($name); ?>" <?php $this->link();
                    checked($this->value(), $value); ?> />
                    <?php
                        if ( is_array($label) ) :
                            echo '<div class="preset_color">';
                            foreach ($label as $k => $color):
                            ?>
            ...
            <script>
                jQuery(window).load(function () {
                    jQuery('#customize-control-<?php echo esc_attr($this->id); ?> label').each(function () {
                        jQuery(this).click(function () {
                            jQuery(this).closest('.customize-control-radio').find('.customize-radio-image').removeClass('customize-radio-image-selected');
                            jQuery(this).addClass('customize-radio-image-selected');
                        })
                    });
                });
            </script>
    ...
    class NOO_Customizer_Control_Same_As_Radio extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            ?>
            <label>
                <input type="checkbox" value="<?php echo esc_attr($same_as_value); ?>"
                       name="<?php echo esc_attr($name); ?>-checkbox" <?php if ($this->value() == $same_as_value) {
            ...
            foreach ($this->choices as $value => $label) :
                ...
                <label <?php if ($same_as_value == $this->value()) echo ' class="hide-option"'; ?>>
                    <input type="radio" value="<?php echo esc_attr($value); ?>"
                           name="<?php echo esc_attr($name); ?>-radio" <?php if ($this->value() != $same_as_value) {
                        checked($this->value(), $value);
                    } ?> />
                    <?php echo esc_html($label); ?><br/>
                </label>
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                if (isset($this->label) && '' !== $this->label) {
                    echo '<span class="customize-control-title noo-alpha-color-title">' . sanitize_text_field($this->label) . '</span>';
                }
                ...
                <input class="alpha-color-control" type="text" data-show-opacity="<?php echo $show_opacity; ?>"
                    ...
                    data-default-color="<?php 
                        if(!empty( $this->settings['default']->default ) ) {
                            echo esc_attr($this->settings['default']->default);
                        }
                    ?>" <?php $this->link(); ?> />
            </label>
            <?php
    ...
    class NOO_Customize_Image_Control extends WP_Customize_Image_Control
    {
        ...
        public function __construct($manager, $id, $args = array(), $options = array())
        {
            ...
            $this->add_tab('library', esc_html__('Media Library', 'noo-landmark-core'), array($this, 'media_library'));
        ...
        public function media_library()
        {
            ...
            <a class="choose-from-library-link button" data-controller="<?php echo esc_attr($this->id); ?>">
                <?php echo esc_html__('Open Library', 'noo-landmark-core'); ?>
            </a>
            <?php
        }
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <a href="#" class="button-primary"
                   onclick="jQuery('#noo-customizer-settings-upload').trigger('click');"><?php echo esc_html($this->label); ?></a>
                <!--  -->
            </label>
            <?php
        }
    ...
    class NOO_Customize_Settings_Download extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            <label>
                <!-- Placeholder -->
                <a id="noo-customizer-settings-download" href="#"
                   class="button-primary"><?php echo esc_html($this->label); ?></a>
                <!--  -->
            </label>
            <?php
        }
    ...
    class NOO_Customizer_Control_Textarea extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            <label>
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <textarea <?php $this->link(); ?> rows="<?php echo esc_attr($row); ?>"
                                                  style="width: 98%;"><?php echo esc_attr($this->value()); ?></textarea>
            </label>
            <?php
        }
    }
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <select <?php $this->link(); ?>>
                    <option value=""><?php echo esc_html__('- Select Sidebar -', 'noo-landmark-core'); ?></option>
                    <?php
        ...
        public function render_content()
        {
            $dropdown = wp_dropdown_pages(
                array(
                    ...
                    'echo' => 0,
                    'show_option_none' => esc_html__( 'None', 'noo-landmark-core' ),
                    'option_none_value' => '',
                    'selected' => $this->value(),
                )
            );
            ...
            $dropdown = str_replace('<select', '<select ' . $this->get_link() . 'data-placeholder="' . esc_html__('- Select Page -', 'noo-landmark-core') . '"', $dropdown);
            ?>
            <label>
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <?php echo $dropdown; ?>
    ...
    // Pages Template.
    //
    class NOO_Customizer_Control_Pages_Template extends WP_Customize_Control
    {
        public $type = 'noo-pages-select';
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <select <?php echo $this->get_link(); ?>>
                    <option value="" <?php selected( '', $this->value()); ?>>
                        <?php echo esc_html__( 'Default', 'noo-landmark-core' ); ?>
                    </option>
                    <?php
                    /**
                     * Get id page half map
                     */
                    $id_page_half_map = noo_get_page_by_template( 'property-half-map.php' );
                    if ( !empty( $id_page_half_map ) ) {
                        echo '<option value="' . $id_page_half_map . '" ' . selected( $id_page_half_map, $this->value(), false ) . '>' . esc_html__( 'Half Map', 'noo-landmark-core' ) . '</option>';
                    }
                    ?>
                </select>
            </label>
    ...
    class NOO_Customizer_Control_Posts_Select extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <select <?php echo $this->get_link(); ?>>
                    <option
                        value="" <?php selected('', $this->value()); ?>><?php echo esc_html($select_holder); ?></option>
                    <?php foreach ($post_list as $post): ?>
                        <option
                            value="<?php echo esc_attr($post->ID); ?>" <?php selected($post->ID, $this->value()); ?>><?php echo esc_html($post->post_title); ?></option>
                    <?php endforeach; ?>
                    ?>
                </select>
            </label>
            ...
            <label>
                ...
                <select <?php echo $this->get_link(); ?>>
                    ...
                    <?php foreach ($terms as $item): ?>
                        <option
                            value="<?php echo esc_attr($item->term_id); ?>" <?php selected($item->term_id, $this->value()); ?>><?php echo esc_html($item->name); ?></option>
                    <?php endforeach; ?>
                    ?>
                </select>
            </label>
    ...
    class NOO_Customizer_Control_Google_Fonts extends WP_Customize_Control
    {
        ...
        public function __construct($manager, $id, $args = array(), $options = array())
        {
            ...
            $this->weight = empty($this->weight) ? noo_get_config('font_weight') : $this->weight;
            ...
            if (empty (self::$font_weight_name))
                self::$font_weight_name = array(
                    '100'       => esc_html__('Extra Light', 'noo-landmark-core'),
                    '100italic' => esc_html__('Extra Light Italic', 'noo-landmark-core'),
                    '200'       => esc_html__('Light', 'noo-landmark-core'),
                    '200italic' => esc_html__('Light Italic', 'noo-landmark-core'),
                    '300'       => esc_html__('Book', 'noo-landmark-core'),
                    '300italic' => esc_html__('Book Italic', 'noo-landmark-core'),
                    'regular'   => esc_html__('Regular', 'noo-landmark-core'),
                    'italic'    => esc_html__('Regular Italic', 'noo-landmark-core'),
                    '500'       => esc_html__('Medium', 'noo-landmark-core'),
                    '500italic' => esc_html__('Medium Italic', 'noo-landmark-core'),
                    '600'       => esc_html__('Semi-bold', 'noo-landmark-core'),
                    '600italic' => esc_html__('Semi-bold Italic', 'noo-landmark-core'),
                    '700'       => esc_html__('Bold', 'noo-landmark-core'),
                    '700italic' => esc_html__('Bold Italic', 'noo-landmark-core'),
                    '800'       => esc_html__('Extra-bold', 'noo-landmark-core'),
                    '800italic' => esc_html__('Extra-bold Italic', 'noo-landmark-core'),
                    '900'       => esc_html__('Heavy', 'noo-landmark-core'),
                    '900italic' => esc_html__('Heavy Italic', 'noo-landmark-core'),
                );
        }
        ...
        public function render_content()
        {
            if (!empty(self::$fonts)) {
                ...
                <div class="noo-font-selects">
                    <select class="noo-font-family noo-customize-chosen"
                            data-placeholder="<?php echo esc_html__('- Font Family -', 'noo-landmark-core'); ?>" <?php $this->link(); ?>>
                        <option value=""></option>
                        <?php
                        $selected_font_id = 0;
                    ...
                    <select class="noo-font-weight-and-style">
                        <option value=""><?php echo esc_html__('- Styles -', 'noo-landmark-core'); ?></option>
                        <?php
                    ...
                    <select class="noo-font-subset"
                            data-customize-setting-link="<?php echo esc_attr($this->id) . '_subset'; ?>">
                        <option value=""><?php echo esc_html__('- Subsets -', 'noo-landmark-core'); ?></option>
                        <?php
                    ...
                    <input type="hidden" class="noo-font-weight" value="<?php echo esc_attr($this->weight); ?>"
                           data-customize-setting-link="<?php echo esc_attr($this->id) . '_weight'; ?>">
                    <input type="hidden" class="noo-font-style" value="<?php echo esc_attr($this->style); ?>"
                           data-customize-setting-link="<?php echo esc_attr($this->id) . '_style'; ?>">
                </div>
                <?php
            }
        }
        ...
        {
            $fontFile = NOO_FRAMEWORK_URI . '/customizer/data/google-web-fonts.txt';
    ...
    class NOO_Customizer_Control_MailChimp_Mail_List extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            <label>
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <input <?php $this->link(); ?> class="regular-text" type="text"
                                               placeholder="<?php echo esc_html__('Mailchimp API key', 'noo-landmark-core'); ?>"
                                               value="<?php echo esc_attr($this->value()); ?>"/>
                <p class="description"><?php echo sprintf(noo_landmark_func_kses(__('Enter Mailchimp API key to connect to your account. Don\'t know where to find? <a href="%s" target="_BLANK">Just click here to get your API</a>', 'noo-landmark-core')), 'https://us5.admin.mailchimp.com/account/api/'); ?></p>
            </label>
