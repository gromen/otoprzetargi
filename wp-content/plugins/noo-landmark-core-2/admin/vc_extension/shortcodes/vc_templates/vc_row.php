...
$output .= '<div class="noo-container-fluid"><div ' . implode( ' ', $wrapper_attributes ) . '>';

// check container
if( isset($container_width) && $container_width == 'yes' ):
    $output .= '<div class="noo-container"><div class="noo-row">';
endif;
