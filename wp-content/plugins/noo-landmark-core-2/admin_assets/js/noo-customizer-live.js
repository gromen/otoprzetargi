...
( function( $ ) {
	...
	// Page Heading Spacing (px)
	wp.customize( 'noo_page_heading_spacing', function( value ) {
		value.bind( function( newval ) {
			additionalStyle = '@media (min-width: 992px) {'; // start @media
			
			// Padding-Left, Padding Right
			additionalStyle += '.noo-page-heading {padding-top: ' + newval + 'px; padding-bottom: ' + (newval - 15) + 'px;}';
    ...
    // rtl
    wp.customize( 'noo_layout_rtl', function( value ) {
		value.bind( function( newval ) {
            $body = $('body');
            switch( newval ) {
                case 'yes':
	...
	wp.customize( 'noo_header_nav_font', function( value ) {
		value.bind( function( newval ) {
			...
			// Update Style
			noo_update_live_css( 'header .noo-main-menu .navbar-nav li > a {font-family: "' + newval + '", sans-serif;}' );
		} );
	} );
	...
	wp.customize( 'noo_header_nav_font_style', function( value ) {
		value.bind( function( newval ) {
			...
			// Update Style
			noo_update_live_css( 'header .noo-main-menu .navbar-nav li > a {font-style: ' + newval + ';}' );
		} );
	} );
	...
	wp.customize( 'noo_header_nav_font_weight', function( value ) {
		value.bind( function( newval ) {
			...
			// Update Style
			noo_update_live_css( 'header .noo-main-menu .navbar-nav li > a{font-weight: ' + newval + ';}' );
		} );
	} );
	...
	wp.customize( 'noo_header_nav_link_hover_color', function( value ) {
		value.bind( function( newval ) {
			...
			// NavBar style
			additionalStyle = 'header .noo-main-menu .navbar-nav li > a:hover,.noo-main-menu .navbar-nav li > a:focus,.noo-main-menu .navbar-nav li:hover > a, .noo-header-minicart .widget_shopping_cart_content .minicart-link-hover:hover, .noo-header-minicart .widget_shopping_cart_content .noo_wrap_minicart a:hover {color: ' + newval + ';}';

			// NavBar menu active
			additionalStyle  += '.noo-main-menu .navbar-nav #magic-line {background: ' + newval + ';}';
			additionalStyle  += 'header .noo-main-menu .navbar-nav li > .sub-menu li a:hover, header .noo-main-menu .navbar-nav li:hover > a, header .noo-main-menu .navbar-nav li > a:hover, header .noo-main-menu .navbar-nav li > a:focus, header .noo-main-menu .navbar-nav li > a:active, header .noo-main-menu .navbar-nav li.current_page_item > a, header .noo-main-menu .navbar-nav li.current-menu-parent > a, header .noo-main-menu .navbar-nav li.current-menu-item > a  {color: ' + newval + ';}';
	...
	wp.customize( 'noo_header_logo_font', function( value ) {
		value.bind( function( newval ) {
			...
			// Update Style
			noo_update_live_css( 'header .navbar-brand {font-family: "' + newval + '", sans-serif;}' );
		} );
	} );
	...
	wp.customize( 'noo_header_logo_font_style', function( value ) {
		value.bind( function( newval ) {
			...
			// Update Style
			noo_update_live_css( 'header .navbar-brand {font-style: ' + newval + ';}' );
		} );
	} );
	...
	wp.customize( 'noo_header_logo_font_weight', function( value ) {
		value.bind( function( newval ) {
			...
			// Update Style
			noo_update_live_css( 'header .navbar-brand {font-weight: ' + newval + ';}' );
		} );
	} );
	...
	wp.customize( 'noo_header_logo_font_color', function( value ) {
		value.bind( function( newval ) {
			...
			noo_update_live_css( 'header .navbar-brand {color: ' + newval + ';}' );
		} );
	} );
	...
	// TopBar Height
	wp.customize( 'noo_header_top_height', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar, header.noo-header .noo-topbar .fa-mobile{';
			additionalStyle += 'height: ' + newval + 'px;';
			additionalStyle += 'line-height: ' + newval + 'px;}';
			additionalStyle += 'header.noo-header .noo-topbar a, header.noo-header .noo-topbar p {';
			additionalStyle += 'line-height: ' + newval + 'px;}';
	...
	// TopBar Background
	wp.customize( 'noo_header_top_bg_color', function( value ) {
		value.bind( function( newval ) {
			if( newval ){
				additionalStyle  = 'header.noo-header .noo-topbar{';
				additionalStyle += 'background-color: ' + newval + ';}';
				noo_update_live_css(additionalStyle);
			}
		} );
	} );
	...
	// TopBar Font
	wp.customize( 'noo_header_top_font', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar, header.noo-header .noo-topbar span, header.noo-header .noo-topbar a, header.noo-header .noo-topbar p {';
			additionalStyle += 'font-family: "' + newval + '", sans-serif;}';

			noo_update_live_css(additionalStyle);
		} );
	} );
	
	wp.customize( 'noo_header_top_font_weight', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar .noo-topmeta, header.noo-header .noo-topbar .noo-topmeta span, header.noo-header .noo-topbar .noo-topmeta a, header.noo-header .noo-topbar .noo-topmeta p {';
			additionalStyle += 'font-weight: ' + newval + ';}';

			noo_update_live_css(additionalStyle);
		} );
	} );

	wp.customize( 'noo_header_top_font_size', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar, header.noo-header .noo-topbar .noo-topmeta-left span,  header.noo-header .noo-topbar .noo-topmeta-left a, header.noo-header .noo-topbar .noo-topmeta-left p {';
	...
	wp.customize( 'noo_header_top_font_size_right', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar .noo-topmeta-right a, header.noo-header .noo-topbar .noo-topmeta-right p, header.noo-header .noo-topbar .noo-topmeta-right {';
			additionalStyle += 'font-size: ' + newval + 'px;}';
	...
	wp.customize( 'noo_header_top_link_color', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar, header.noo-header .noo-topbar .noo-topmeta, header.noo-header .noo-topbar span, header.noo-header .noo-topbar a, header.noo-header .noo-topbar p {';
			additionalStyle += 'color: ' + newval + ' !important;}';
	...
	// TopBar link hover
	wp.customize( 'noo_header_top_link_hover_color', function( value ) {
		value.bind( function( newval ) {
			additionalStyle  = 'header.noo-header .noo-topbar a:hover {color: ' + newval + ' !important;}';
	...
	wp.customize( 'noo_header_nav_height', function( value ) {
		value.bind( function( newval ) {
			...
			additionalStyle += 'header.header_agency .menu-nav-control, .noo-header .noo-menu-option ul li a, .noo-header .noo-menu-option .button-menu-extend, header .noo-menu-option .button-expand-option { line-height: ' + newval + 'px;}';
			...
			// Navbar Meta
			additionalStyle += 'header .navbar-meta{';
			additionalStyle += 'height:' + newval + 'px;}';
			additionalStyle += '.noo-header-minicart .widget_shopping_cart_content .minicart-link-hover{';
			additionalStyle += 'line-height:' + newval + 'px;}';
			additionalStyle += 'header .navbar-meta.meta-social{';
			additionalStyle += 'line-height:' + newval + 'px;}';
			// Property
			additionalStyle += 'header .navbar-meta .meta-content .meta-property{';
			additionalStyle += 'margin-top:' + (newval - 50)/2 + 'px !important;}';
	...
	wp.customize( 'noo_header_nav_link_spacing', function( value ) {
		value.bind( function( newval ) {
			...
			// Padding-Left, Padding Right
			additionalStyle += 'header .noo-main-menu .navbar-nav > li > a {margin-left: ' + newval + 'px; margin-right: ' + newval + 'px;}';
